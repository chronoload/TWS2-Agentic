...
def wiki_url(workspace_id, wiki_id):
    return f"{TAPD_WEB}/{workspace_id}/markdown_wikis/show/#{wiki_id}"
...
def cmd_sync():
    ...
    if not workspace_ids:
        ...
        sys.exit(1)
    if not TOKEN:
        print("错误: 未配置 TAPD_TOKEN", file=sys.stderr)
        sys.exit(1)
